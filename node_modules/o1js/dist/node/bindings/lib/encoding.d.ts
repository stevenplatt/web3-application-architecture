 ...
 */
declare function stringToFields(message: string): import("../../lib/field.js").Field[];
/**
 ...
 */
declare function bytesToFields(bytes: Uint8Array): import("../../lib/field.js").Field[];
/**
...
declare const Bijective: {
    Fp: {
        ...
        fromBytes: (bytes: Uint8Array) => import("../../lib/field.js").Field[];
        toString(fields: Field[]): string;
        fromString(message: string): import("../../lib/field.js").Field[];
    };
    Fq: {
        toBytes: (fields: Field[]) => Uint8Array;
        fromBytes: (bytes: Uint8Array) => import("../../lib/field.js").Field[];
