...
import { PubSub, Message, StrictNoSign, StrictSign, PubSubInit, PubSubEvents, PeerStreams, PubSubRPCMessage, PubSubRPC, PubSubRPCSubscription, PublishResult, TopicValidatorFn } from '@libp2p/interface-pubsub';
 ...
 */
export declare abstract class PubSubBaseProtocol<Events extends {
    [s: string]: any;
} = PubSubEvents> extends EventEmitter<Events> implements PubSub<Events> {
    started: boolean;
    /**
     ...
     */
    getMsgId(msg: Message): import("multiformats/dist/types/src/hashes/hasher.js").Await<Uint8Array>;
    /**
