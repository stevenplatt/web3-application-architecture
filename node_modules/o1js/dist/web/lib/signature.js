...
import { deriveNonce, Signature as SignatureBigint, } from '../mina-signer/src/signature.js';
import { Bool as BoolBigint } from '../provable/field-bigint.js';
import { Scalar as ScalarBigint, PrivateKey as PrivateKeyBigint, PublicKey as PublicKeyBigint, } from '../provable/curve-bigint.js';
...
class PrivateKey extends CircuitValue {
    ...
    static toBase58(privateKey) {
        return PrivateKeyBigint.toBase58(constantScalarToBigint(privateKey.s, 'PrivateKey.toBase58'));
    }
}
__decorate([
    prop,
