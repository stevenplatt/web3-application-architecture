import { Fp, inverse, mod, p, q } from './finite_field.js';
export { Pallas, Vesta, GroupMapPallas };
...
function projectiveEqual(g, h, p) {
    ...
    if (mod(g.x * hz2, p) !== mod(h.x * gz2, p))
        return false;
...
function createCurveProjective(p, generator, endoBase, endoScalar, b, a) {
    return {
        zero: projectiveZero,
        one: generator,
        endoBase,
...
const Pallas = createCurveProjective(p, pallasGeneratorProjective, pallasEndoBase, pallasEndoScalar, b, a);
const Vesta = createCurveProjective(q, vestaGeneratorProjective, vestaEndoBase, vestaEndoScalar, b, a);
