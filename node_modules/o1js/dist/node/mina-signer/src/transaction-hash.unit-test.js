...
test(RandomTransaction.signedPayment, RandomTransaction.signedDelegation, (payment, delegation) => {
    ...
    let result = Test.transactionHash.serializeCommon(JSON.stringify(commonToOcaml(payment.data.common)));
    ...
    let v1Bytes0 = stringToBytesOcaml(Test.encoding.ofBase58(ocamlBase58V1, versionBytes.signedCommandV1).c);
    ...
    v1Bytes0 = stringToBytesOcaml(Test.encoding.ofBase58(ocamlBase58V1, versionBytes.signedCommandV1).c);
