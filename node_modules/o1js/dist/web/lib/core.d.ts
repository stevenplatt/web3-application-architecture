 ...
 */
declare const Field: typeof InternalField & ((x: string | number | bigint | Uint8Array | import("./field.js").FieldVar | InternalField) => InternalField);
 ...
 * ```
 */
declare const Bool: typeof InternalBool & ((x: boolean | InternalBool | import("./field.js").FieldVar) => InternalBool);
type Bool = InternalBool;
/**
 * An element of a Group.
 */
declare const Group: typeof InternalGroup & ((args_0: {
    x: string | number | bigint | import("./field.js").FieldVar | InternalField;
    y: string | number | bigint | import("./field.js").FieldVar | InternalField;
}) => InternalGroup);
