...
pub_ips.forEach(ip_addr => {
  // console.log(is_ip_private)
  console.log(is_ip_private(ip_addr.toString()))
  // test(`IP ${ip_addr.toString()} should be public`, t => t.false(is_ip_private(ip_addr)))
})
