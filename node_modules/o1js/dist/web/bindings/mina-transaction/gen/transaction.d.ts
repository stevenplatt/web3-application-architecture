import { PublicKey, UInt64, UInt32, TokenId, Field, Bool, AuthRequired, Sign } from '../transaction-leaves.js';
...
declare let provableFromLayout: <T, TJson>(typeData: GenericLayout<TypeMap>) => {
    sizeInFields(): number;
    toFields(value: T): import("../../../lib/field.js").Field[];
    toAuxiliary(value?: T | undefined): any[];
    fromFields(fields: import("../../../lib/field.js").Field[], aux: any[]): T;
...
declare let ZkappCommand: {
    sizeInFields(): number;
    toFields(value: ZkappCommand): import("../../../lib/field.js").Field[];
    toAuxiliary(value?: ZkappCommand | undefined): any[];
    fromFields(fields: import("../../../lib/field.js").Field[], aux: any[]): ZkappCommand;
...
declare let AccountUpdate: {
    sizeInFields(): number;
    toFields(value: AccountUpdate): import("../../../lib/field.js").Field[];
    toAuxiliary(value?: AccountUpdate | undefined): any[];
    fromFields(fields: import("../../../lib/field.js").Field[], aux: any[]): AccountUpdate;
...
declare let Account: {
    sizeInFields(): number;
    toFields(value: Account): import("../../../lib/field.js").Field[];
    toAuxiliary(value?: Account | undefined): any[];
    fromFields(fields: import("../../../lib/field.js").Field[], aux: any[]): Account;
