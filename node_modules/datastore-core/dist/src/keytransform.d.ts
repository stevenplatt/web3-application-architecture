...
export class KeyTransformDatastore extends BaseDatastore implements Datastore {
     ...
     */
    query(q: Query, options?: import("interface-datastore").Options | undefined): AsyncGenerator<{
        key: import("interface-datastore").Key;
        value: Uint8Array;
    }, void, undefined>;
    /**
     * @param {KeyQuery} q
     * @param {Options} [options]
     */
    queryKeys(q: KeyQuery, options?: import("interface-datastore").Options | undefined): AsyncGenerator<import("interface-datastore").Key, void, undefined>;
}
